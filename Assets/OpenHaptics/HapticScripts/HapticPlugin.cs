...
public class HapticPlugin : MonoBehaviour  {
	...
	//[DisplayOnlyAttribute] public bool inkwellBool;
    ...
    [DllImport("hl")] public static extern void hlGetBooleanv(string paramName, ref bool inkwellBool);
	...
	private void updateDevice()
	{
		...
		//hlGetBooleanv("HL_INKWELL_STATE", ref inkwellBool);
