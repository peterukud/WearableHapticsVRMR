...
public class HapticFitToCamera : MonoBehaviour 
{
	...
	void Start () 
	{
		masterCamera = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<Camera>();
	}
	...
	void Update () 
	{
		...
		// Dimensions of the box defined by camera-to-box distance defined above, and the camera frustrum
		...
		// Compare the haptic box with the camera box to determine culling.
